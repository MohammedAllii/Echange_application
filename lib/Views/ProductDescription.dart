...
import 'package:flutter_simple_page/Views/UserProductsScreen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        onPressed: () {
                    // Navigate to the user's products page with the productId
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => UserProductsScreen(id : widget.product.id),
                      ),
                    );
                  },
        ...
        style: ElevatedButton.styleFrom(
          primary: Color.fromARGB(255, 4, 219, 231), // Set the background color to green
        ),
      )
              ),
            ),
